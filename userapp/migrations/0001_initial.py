    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ltp', models.IntegerField(blank=True, null=True)),
                ...
                ('av_tp', models.FloatField(blank=True, null=True)),
                ('spot_price', models.FloatField(blank=True, null=True)),
                ('sp_date_time', models.CharField(blank=True, max_length=45, null=True)),
                ('best_buy', models.FloatField(blank=True, null=True)),
                ('best_sell', models.FloatField(blank=True, null=True)),
                ('oi', models.IntegerField(blank=True, db_column='OI', null=True)),
            ],
            options={
